<div class="navbar navbar-top navbar-inverse">
	<div class="navbar-inner">
		<div class="container-fluid">
			<a class="brand" href="<?php echo base_url();?>index.php?multilanguage/select_language/portuguese"><?php echo $system_name;?>
			</a>
			...
			<div class="nav-collapse nav-collapse-top collapse">
				<ul class="nav pull-right">
                    ...
                    <ul class="dropdown-menu">
						...
						<li><a href="<?php echo base_url();?>index.php?login/logout" >
                        		...
                        		<i class="icon-off"></i><span><?php echo
                        		get_phrase('logout');?></span></a></li>
					</ul>
                	<!-- Account Selector -->
					</li>
				</ul>
				<ul class="nav pull-right">
					<li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo get_phrase('selecione_o_idioma');?><b class="caret"></b></a>
					<!-- Language Selector -->
                        <ul class="dropdown-menu">
                            <?php
                ...
                <ul class="nav pull-right">
					<li class="dropdown">
					<a href="<?php echo base_url();?>index.php" ><i class="icon-user"></i><?php echo get_phrase('panel');?> </a>
					</li>
				</ul>
			</div>
		</div>
