                        	...
                        	<?php echo form_open('login' , array('class' => 'separate-sections'));?>
                                <div class="">
                                    ...
                                    <select class="validate[required]" name="login_type" style="width:100%;">
                                        <option value=""><?php echo get_phrase('Tipo de Conta');?></option>
                                        <option value="admin"><?php echo get_phrase('Admin');?></option>
                                        <option value="doctor"><?php echo get_phrase('Medico');?></option>
                                        <option value="laboratorist"><?php echo get_phrase('Atendente');?></option>
