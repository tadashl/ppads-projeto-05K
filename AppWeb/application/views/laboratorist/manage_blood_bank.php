		...
		<ul class="nav nav-tabs nav-tabs-left">
			...
			<li class="active">
            	<a href="#edit" data-toggle="tab"><i class="icon-wrench"></i> 
					<?php echo get_phrase('Editar_vacinas');?>
                    	</a></li>
            <?php endif;?>
                ...
                <div class="box-content">
                    ...
                    <?php echo form_open('laboratorist/manage_blood_bank/edit/do_update/'.$row['blood_group_id'] , array('class' => 'form-horizontal validatable'));?>
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-blue"><?php echo get_phrase('Editar_Vacinas');?></button>
                        </div>
                    <?php echo form_close();?>
                    <?php endforeach;?>
                </div>
            ...
            <div class="tab-pane box <?php if(!isset($edit_profile))echo 'active';?>" id="list">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                	<thead>
                		<tr>
                    		<th><div>#</div></th>
                    		<th><div><?php echo get_phrase('Grupo_Vacinas');?></div></th>
